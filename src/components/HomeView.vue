...
export default {
  ...
  methods: {
    ...
    win (nbCookie, baitValue) {
      ...
      this.$http.put('http://localhost/chifucookieapi/public/cookies/' + this.userid + '/' + this.cookies + '')
    },
  ...
  mounted () {
    this.$http.get('http://localhost/chifucookieapi/public/cookies/' + this.userid).then(response => {
      this.cookies = parseInt(response.body.cookies)
    })
    this.$http.get('http://localhost/chifucookieapi/public/rank').then(response => {
